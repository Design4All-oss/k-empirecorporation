export const HOME_CONTENT = {
  ...
  testimonials: {
    ...
    citations: [
      { id: 1, quote: "Leurs équipes sont agréables avec qui travailler et m'ont aidé à créer des sites Web incroyables en peu de temps. Merci pour votre travail acharné. Nous avons cherché pendant très longtemps.", name: "Herman Miller", role: "Monday", image: "01.png" },
      { id: 2, quote: "Leur équipe est facile avec qui travailler et m'a aidé à créer des sites Web incroyables en peu de temps. Merci pour votre travail acharné. Nous avons cherché pendant très longtemps.", name: "Leonel Mooney", role: "Logitech", image: "02.png" },
      { id: 3, quote: "Leurs équipes sont agréables avec qui travailler et m'ont aidé à créer des sites Web incroyables en peu de temps. Merci pour votre travail acharné. Nous avons cherché pendant très longtemps.", name: "Matthew Taylor", role: "Invision", image: "03.png" }
    ]
  },
  contact: {
